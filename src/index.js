...
(async () =>
{
    ...
    const columns = window.innerWidth < 800 ? constants.DEFAULT_COLUMNS_MOBILE : constants.DEFAULT_COLUMNS;
    const rows = window.innerWidth < 800 ? constants.DEFAULT_ROWS_MOBILE : constants.DEFAULT_ROWS;
    const pins = window.innerWidth < 800 ? constants.DEFAULT_PINS_MOBILE : constants.DEFAULT_PINS;
